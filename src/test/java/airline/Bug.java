  ...
  */ 
 @ThreadSafe 
 public  class Bug implements Runnable{Object obj3 =  new Object(); Object obj4 =  new Object();  
 	...
 	Num_of_tickets_issued = size;    
         ...
         for( int i=0; i < Num_of_tickets_issued; i++) { 
             ...
             */ 
             if( StopSales ){ 
                  synchronized(obj4) { Num_Of_Seats_Sold--; }  
          ...
          synchronized(obj4) { if (Num_Of_Seats_Sold > Maximum_Capacity) 
     ...
     */ 
     public void run() { 
         synchronized(obj4) { Num_Of_Seats_Sold++; }                                               // making the sale 
         synchronized(obj4) { if (Num_Of_Seats_Sold > Maximum_Capacity)  // checking 
